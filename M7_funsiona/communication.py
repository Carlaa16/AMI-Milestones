...
class COMMS:
    def __init__(self, Inputs):
        ...
        if uplink_data_size_bits < 0:
            self.gui.show_popup('Introduzca un tamaño se mensaje se satélite válido.', 'Input eror')
            return
        
        downlink_data_size_bits = float(Inputs["Tamaño mensaje estación:"]) # Tamaño total de datos
        if uplink_data_size_bits < 0:
            self.gui.show_popup('Introduzca un tamaño se mensaje se de la estación válido.', 'Input eror')
            return   
...
####################################### Visualización de datos #####################################
    def plot_satellite_fov(self, satellite_positions_copia, fov_angle, background_image_path, output_path):
        ...
        image_path = os.path.join(output_path, "FOV Satélites")
